...
const educationData = [
  {
    ...
    date: "2022 - Present",
    details: [
      "Focus on web development, databases, and software engineering — building production Laravel apps alongside coursework",
      "Capstone: NCIP Hybrid Blockchain-Powered Management System (Laravel + ABAC)",
      "Coursework in data structures, database systems, web development, and cloud computing",
    ],
  },
  {
    level: "Senior High School",
    degree: "Technical Vocational Livelihood (TVL) - Agriculture Strand",
    institution: "Digos City National High School",
    date: "2019 - 2021",
    details: [
      "Graduated with honors",
      "Hands-on training in agricultural crop production and farm practices",
    ],
  },
];
